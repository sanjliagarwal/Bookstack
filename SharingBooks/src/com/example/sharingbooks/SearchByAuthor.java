...
public class SearchByAuthor extends Activity implements OnClickListener,OnItemClickListener {
	EditText name;
	...
	private static String url_create_product = "http://192.168.43.147/sbphp/checkingbyauthor.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.searchbyauthor);
		ActionBar bar = getActionBar();
		bar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#000000")));
		
		name = (EditText) findViewById(R.id.searchauthor);
		searchbutt = (ImageButton) findViewById(R.id.searchbuttonauthor);
		lv = (ListView) findViewById(R.id.searchlvauthor);
	...
	public void onClick(View v) {
		...
		ad.setCancelable(false);
		ad.setTitle("Alert!");
		ad.setMessage("Type the name of author whose books you are searching");
		AlertDialog message = ad.create();
		String nametext;
		...
		if ((nametext == null) || (nametext.length() == 0)) {
			...
			detail.clear();
			new searchbyauthorjson().execute();
			Log.i("CLOCKS", "Json is properly executed");

		}
	}

	class searchbyauthorjson extends AsyncTask<String, String, String> {
		int vv;
		protected String doInBackground(String... args) {
			String sauthor = name.getText().toString();

			List<NameValuePair> params = new ArrayList<NameValuePair>();
			params.add(new BasicNameValuePair("name", sauthor));
			// getting JSON Object
			...
			try {
				...
				if (success == 1) {
					...
					Log.i("CLOCKS", "List is formed");
						...
						Intent myintent = new Intent(SearchByAuthor.this, SearchByAuthor.class);
		...
		protected void onPostExecute(String file_url) {
			...
			ca=new CustomAdapter(SearchByAuthor.this,R.layout.itemlist2string,detail);
			...
			Log.i("CLOCKS", "Content set");
				...
				Toast tt=Toast.makeText(SearchByAuthor.this, "Element not found",
						Toast.LENGTH_LONG);
				tt.show();
			}
		}
	...
	public void onItemClick(AdapterView<?> arg0, View v, int arg2, long arg3) {
		...
		Intent i=new Intent(SearchByAuthor.this,DisplayDetails.class);
		if (i!=null)
		{
